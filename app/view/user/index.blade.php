					...
					<div class="carousel-inner" role="listbox">
						<div class="item active">
							<div class="single_review">
								<img src="resources/images/review/person1.jpg" alt="" />
						...
						<div class="item">
							<div class="single_review">
								<img src="resources/images/review/person2.jpg" alt="" />
								<h5><a href="#">Michelle Wilson</a></h5>
								<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry Lorem Ipsum has been the industry's</p>
								<div class="review_line"></div>
								<div class="review_icon">
						...
						<div class="item">
							<div class="single_review">
								<img src="resources/images/review/person3.jpg" alt="" />
								<h5><a href="#">Michelle Wilson</a></h5>
								<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry Lorem Ipsum has been the industry's</p>
								<div class="review_line"></div>
								<div class="review_icon">
					...
					<div role="tabpanel" class="tab-pane fade in items_pane" id="guarantee">
						<div class="guarantee_box">
							<div class="guarantee_features">
								<img src="resources/images/guarantee-icon.png" alt="" />
